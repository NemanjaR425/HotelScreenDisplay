  ...
  return (
    ...
    >
      <div className="h-full flex gap-3">
        ...
        <div className="w-[48rem] grid grid-cols-4 gap-4" style={{ gridTemplateRows: '1fr 1fr 1fr' }}>
          <ServiceCategory category="dining" title={t.dining} className="col-span-2" />
          <ServiceCategory category="shopping" title={t.shopping} className="col-span-2" />
          <ServiceCategory category="excursions" title={t.excursions} className="col-span-2" />
          <ServiceCategory category="entertainment" title={t.entertainment} className="col-span-2" />
          <ServiceCategory category="spa" title={t.spa} className="col-span-4" />
        </div>
      </div>
    </div>
  );
